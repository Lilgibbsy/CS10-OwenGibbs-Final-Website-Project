...
if (
  ...
  inFour.toLowerCase() == "bow and arrow"
) {
  resultFour = 1;
...
if (
  ...
  inEight.toLowerCase() == "tony stark" ||
  inEight.toLowerCase() == "tonystark"
) {
  resultEight = 1;
